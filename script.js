...
const menuItems = [
  ...
  { id: 2, category: 'kahvalti', name: 'Çabuk Kahvaltı', price: 390, desc: 'Bal, yeşil biber, salatalık, domates, ezine peyniri, taze kaşar, reçel, simit, tereyağı, haşlanmış yumurta, siyah zeytin, yeşil zeytin, yanında 2 adet çay. (1439 kcal)', img: 'photos/çabuk-kahvaltı.jpg', allergens: ['gluten', 'sut', 'yumurta', 'susam'] },
