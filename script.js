...
const menuItems = [
  ...
  { id: 1, category: 'kahvalti', name: 'Serpme Kahvaltı (2 Kişilik)', price: 950, desc: 'Menemen veya sucuklu yumurta, ezine beyaz peyniri, taze kaşar, salam, siyah zeytin, yeşil zeytin, sürme çikolata, bal, tereyağı, domates, salatalık, yeşil biber, maydonoz, patates kızartması, peynirli su böreği ve sınırsız çay. (1750 kcal)', img: 'photos/serpme-kahvaltı.png', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 2, category: 'kahvalti', name: 'Çabuk Kahvaltı', price: 390, desc: 'Bal, yeşil biber, salatalık, domates, ezine peyniri, taze kaşar, sürme çikolata, simit, tereyağı, haşlanmış yumurta, siyah zeytin, yeşil zeytin, yanında 2 adet çay. (1439 kcal)', img: 'photos/çabuk-kahvaltı.jpg', allergens: ['gluten', 'sut', 'yumurta', 'susam'] },
  ...
  { id: 5, category: 'kahvalti', name: 'Sahanda Sucuklu Yumurta', price: 180, desc: 'Sucuk dilimleri ile pişirilmiş yumurta. (430 kcal)', img: 'photos/Sahanda Sucuklu Yumurta.jpg', allergens: ['yumurta'] },
  ...
  { id: 8, category: 'kahvalti', name: 'Sucuklu Menemen', price: 210, desc: 'Sucuk dilimleri ile hazırlanmış menemen. (432 kcal)', img: 'photos/sucuklumenemen.png', allergens: ['yumurta'] },
  { id: 9, category: 'kahvalti', name: 'Sade Omlet', price: 175, desc: 'Patates kızartması ve mevsim yeşillikleri ile servis edilir. (220 kcal)', img: 'photos/sadeomlet.png', allergens: ['yumurta'] },
  { id: 10, category: 'kahvalti', name: 'Beyaz Peynirli Omlet', price: 190, desc: 'Patates kızartması ve mevsim yeşillikleri ile servis edilir. (318 kcal)', img: 'photos/peynirliomlet.png', allergens: ['sut', 'yumurta'] },

  // --- BÖREKLER, POĞAÇALAR VE TOSTLAR ---
  { id: 11, category: 'borek', name: 'Peynirli Su Böreği', price: 260, desc: 'Tereyağlı, peynirli su böreği. (223 kcal)', img: 'photos/Peynirli Su Böreği.jpg', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 12, category: 'borek', name: 'Kıymalı Kol Böreği', price: 290, desc: 'Dana kıymalı iç harcı ile çıtır kol böreği. (272 kcal)', img: 'photos/kolböreğikıymalı.jpg', allergens: ['gluten', 'yumurta'] },
  { id: 13, category: 'borek', name: 'Patatesli Boşnak Böreği', price: 260, desc: 'Patates harçlı el açması Boşnak böreği. (255 kcal)', img: 'photos/Boşnak Böreği - Patatesli porsiyon.jpg', allergens: ['gluten', 'yumurta'] },
  { id: 14, category: 'borek', name: 'Kıymalı Boşnak Böreği', price: 320, desc: 'Dana kıymalı geleneksel Boşnak böreği. (220 kcal)', img: 'photos/Boşnak Böreği - Kıymalı porsiyon.jpg', allergens: ['gluten', 'yumurta'] },
  ...
  { id: 17, category: 'borek', name: 'Dereotlu Poğaça', price: 45, desc: 'Taze dereotlu poğaça. (446 kcal)', img: 'photos/poğaçadereotlu.jpg', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 18, category: 'borek', name: 'Simit', price: 40, desc: 'Susamlı simit. (302 kcal)', img: 'photos/Sokak Simidi.jpg', allergens: ['gluten', 'susam'] },
  { id: 19, category: 'borek', name: 'Beyaz Peynirli Tost', price: 180, desc: 'Ekşi mayalı tost ekmeğinde ezine peyniri, yanında mevsim yeşillikleri. (240 kcal)', img: 'photos/peynirli-tost.png', allergens: ['gluten', 'sut'] },
  { id: 20, category: 'borek', name: 'Kaşarlı Tost', price: 180, desc: 'Ekşi mayalı tost ekmeğinde erimiş Mihaliç peyniri, yanında mevsim yeşillikleri. (275 kcal)', img: 'photos/kasarlı-tost.png', allergens: ['gluten', 'sut'] },
  { id: 21, category: 'borek', name: 'Karışık Tost', price: 210, desc: 'Ekşi mayalı tost ekmeğinde erimiş Mihaliç peyniri ile dilim dana sucuk, yanında mevsim yeşillikleri. (292 kcal)', img: 'photos/sucuklu-tost1.png', allergens: ['gluten', 'sut'] },
  ...
  { id: 26, category: 'atistirmalik', name: 'Çıtır Tavuk Parçaları', price: 210, desc: 'Pane kaplamalı çıtır tavuk göğsü dilimleri, yanında baharatlı patates kızartması ile. (280 kcal)', img: 'photos/çıtırtavuk1.jpg', allergens: ['gluten', 'yumurta'] },
  { id: 27, category: 'atistirmalik', name: 'Patates Kızartması', price: 150, desc: 'Baharatlı patates kızartması. (230 kcal)', img: 'photos/Patates Kızartması.jpg', allergens: [] },
  { id: 28, category: 'atistirmalik', name: 'Kaşar Peynirli Baget Sandviç', price: 150, desc: 'Baget ekmeğinde taze kaşar peyniri, salatalık, domates, krem peyniri ve yeşillik. (220 kcal)', img: 'photos/peynirli-baget.png', allergens: ['gluten', 'sut'] },
  { id: 29, category: 'atistirmalik', name: 'Peynirli Baget Sandviç', price: 150, desc: 'Baget ekmeğinde taze beyaz peyniri, salatalık, domates, krem peyniri ve yeşillik. (170 kcal)', img: 'photos/peynirli-baget.png', allergens: ['gluten', 'sut'] },
  { id: 30, category: 'atistirmalik', name: 'Kaşarlı Salamlı Baget Sandviç', price: 160, desc: 'Baget ekmeğinde dana salam, taze kaşar peyniri, salatalık, domates ve labne. (190 kcal)', img: 'photos/salamlı-baget.png', allergens: ['gluten', 'sut'] },
  { id: 31, category: 'atistirmalik', name: 'Tavuklu Sezar Salata', price: 270, desc: 'Izgara tavuk, kruton ekmek ve Sezar sos. (270 kcal)', img: 'photos/tavuklusezar.jpg', allergens: ['gluten', 'sut', 'yumurta'] },
  ...
  { id: 33, category: 'atistirmalik', name: 'Akdeniz Salata', price: 230, desc: 'Yeşillikler, beyaz peynir, mısır, domates ve zeytinyağlı sos. (230 kcal)', img: 'photos/akdenizsalata.jpg', allergens: ['sut'] },
  ...
  { id: 35, category: 'ana-yemek', name: 'Izgara Köfte', price: 460, desc: 'Izgara köfte, pilav, patates kızartması, közlenmiş biber ve mevsim yeşillikleri ile servis edilir. (270 kcal)', img: 'photos/Köfte Porsiyon.jpg', allergens: ['gluten'] },
  { id: 36, category: 'ana-yemek', name: 'Köri Soslu Tavuk', price: 380, desc: 'Özel köri soslu sotelenmiş tavuk, pilav, patates kızartması ve mevsim yeşillikleri ile servis edilir. (165 kcal)', img: 'photos/körisoslutavuk.jpg', allergens: ['sut'] },
  { id: 37, category: 'ana-yemek', name: 'Aslı Burger', price: 450, desc: '160g dana burger köftesi, dana füme, karamelize soğan, cheddar, domates, patates kızartması ve mevsim yeşillikleri ile servis edilir. (295 kcal)', img: 'photos/Aslı burger.jpg', allergens: ['gluten', 'sut', 'susam'] },
  { id: 38, category: 'ana-yemek', name: 'Hamburger', price: 380, desc: '160g dana köfte, yeşillik, turşu, domates, patates kızartması ve mevsim yeşillikleri ile servis edilir. (260 kcal)', img: 'photos/hamburger.jpg', allergens: ['gluten', 'susam'] },
  { id: 39, category: 'ana-yemek', name: 'Cheeseburger', price: 350, desc: '160g dana köfte, cheddar peyniri, turşu, domates, patates kızartması ve mevsim yeşillikleri ile servis edilir. (280 kcal)', img: 'photos/cheeseburger.jpg', allergens: ['gluten', 'sut', 'susam'] },
  { id: 40, category: 'ana-yemek', name: 'Tavuk Dürüm', price: 320, desc: 'Jülyen tavuk, kırmızı ve yeşil biber, lavaş ekmeği, cheddar, patates ve mevsim yeşillikleri ile servis edilir. (145 kcal)', img: 'photos/Tavuk Dürüm.jpg', allergens: ['gluten', 'sut'] },
  { id: 41, category: 'ana-yemek', name: 'Köfte Dürüm', price: 380, desc: 'Izgara köfte,kırmızı ve yeşil biber, lavaş ekmeği, cheddar, patates ve mevsim yeşillikleri ile servis edilir. (165 kcal)', img: 'photos/Dürüm Köfte.jpg', allergens: ['gluten', 'sut'] },
  { id: 45, category: 'ana-yemek', name: 'Penne Arabiata', price: 275, desc: 'Sarımsaklı, acı domates soslu penne makarna. (175 kcal)', img: 'photos/pennearabiate.jpg', allergens: ['gluten', 'sut'] },
  ...
  { id: 48, category: 'ana-yemek', name: 'Fettucini Alfredo', price: 325, desc: 'Tavuk göğsü, krema, mantarlı fettucini. (225 kcal)', img: 'photos/fettucino.jpg', allergens: ['gluten', 'sut', 'yumurta'] },
  ...
  { id: 50, category: 'tatli', name: 'Profiterol', price: 370, desc: 'Özel çikolata soslu profiterol topları. (315 kcal)', img: 'photos/Profiterol Porsiyon.jpg', allergens: ['gluten', 'sut', 'yumurta'] },
  ...
  { id: 55, category: 'tatli', name: 'Aslı Cup', price: 255, desc: 'Krema, çilekli Aslı Cup. (260 kcal)', img: 'photos/Aslı Cup.jpg', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 56, category: 'tatli', name: 'Fıstıklı Baklava', price: 380, desc: 'Antep fıstıklı çıtır baklava. (422 kcal)', img: 'photos/baklavafıstıklı.jpg', allergens: ['gluten', 'sut', 'kuruyemis'] },
  { id: 57, category: 'tatli', name: 'Cevizli Ev Baklavası', price: 330, desc: 'Bol cevizli ev baklavası. (401 kcal)', img: 'photos/cevizlievbaklavası2.png', allergens: ['gluten', 'sut', 'kuruyemis'] },
  { id: 58, category: 'tatli', name: 'Fıstıklı Kadayıf', price: 350, desc: 'Antep fıstıklı şerbetli kadayıf. (422 kcal)', img: 'photos/kadayıfporsiyon.jpg', allergens: ['gluten', 'sut', 'kuruyemis'] },
  { id: 59, category: 'tatli', name: 'Cevizli Sarı Burma', price: 320, desc: 'Cevizli sarı burma tatlısı. (401 kcal)', img: 'photos/Sarı Burma - Porsiyon.jpg', allergens: ['gluten', 'sut', 'kuruyemis'] },
  { id: 60, category: 'tatli', name: 'Brownie', price: 335, desc: 'Çikolatalı, vişneli brownie. (450 kcal)', img: 'photos/brownie.jpg', allergens: ['gluten', 'sut', 'yumurta'] },
  ...
  // --- SICAK İÇECEKLER ---
  { id: 73, category: 'sicak-icecek', name: 'Aslı Çay', price: 50, desc: 'Geleneksel taze demlenmiş bardak Aslı çay.', img: 'photos/çay.jpg', allergens: [] },
  { id: 74, category: 'sicak-icecek', name: 'Aslı Fincan Çay', price: 70, desc: 'Büyük fincanda demlenmiş Aslı çay.', img: 'photos/fincan02.jpg', allergens: [] },
  { id: 75, category: 'sicak-icecek', name: 'Bitki Çayları', price: 150, desc: 'Ihlamur, adaçayı, yeşil çay seçenekleri.', img: 'photos/Aslı Bardak kahve (1).png', allergens: [] },
  { id: 76, category: 'sicak-icecek', name: 'Türk Kahvesi', price: 120, desc: 'Geleneksel köpüklü Türk kahvesi.', img: 'photos/Türk kahvesi.jpg', allergens: [] },
  { id: 77, category: 'sicak-icecek', name: 'Duble Türk Kahvesi', price: 140, desc: 'Duble fincanda sunulan Türk kahvesi.', img: 'photos/Türk kahvesi.jpg', allergens: [] },
  { id: 78, category: 'sicak-icecek', name: 'Caffe Latte', price: 160, desc: 'Espresso ve sıcak süt. (120 kcal)', img: 'photos/Buzlu Latte.jpg', allergens: ['sut'] },
  { id: 79, category: 'sicak-icecek', name: 'Caramel Latte', price: 190, desc: 'Karamel aromalı sıcak Caffe Latte. (180 kcal)', img: 'photos/Aslı Karamelli Frappe.jpg', allergens: ['sut'] },
  { id: 80, category: 'sicak-icecek', name: 'Cappuccino', price: 160, desc: 'Yoğun espresso ve süt köpüğü. (90 kcal)', img: 'photos/Aslı Espresso Frappe.jpg', allergens: ['sut'] },
  { id: 81, category: 'sicak-icecek', name: 'Caffe Mocha', price: 175, desc: 'Espresso, çikolata sosu ve süt. (210 kcal)', img: 'photos/Buzlu Mocha.jpg', allergens: ['sut'] },
  { id: 82, category: 'sicak-icecek', name: 'White Chocolate Mocha', price: 175, desc: 'Beyaz çikolata soslu Caffe Mocha. (240 kcal)', img: 'photos/Buzlu White Chocolate Mocha.jpg', allergens: ['sut'] },
  { id: 83, category: 'sicak-icecek', name: 'Americano', price: 140, desc: 'Sıcak su ile inceltilmiş zengin espresso. (3 kcal)', img: 'photos/espresso_americano.png', allergens: [] },
  { id: 84, category: 'sicak-icecek', name: 'Espresso', price: 100, desc: 'Yoğun ve taze çekilmiş kahve özü. (3 kcal)', img: 'photos/espresso_americano.png', allergens: [] },
  { id: 85, category: 'sicak-icecek', name: 'Duble Espresso', price: 140, desc: 'Çift shot zengin espresso. (6 kcal)', img: 'photos/espresso_americano.png', allergens: [] },
  { id: 86, category: 'sicak-icecek', name: 'Filtre Kahve', price: 130, desc: 'Taze demlenmiş filtre kahve. (2 kcal)', img: 'photos/Filtre Kahve Paket Aslılow.jpg', allergens: [] },
  { id: 87, category: 'sicak-icecek', name: 'Salep', price: 175, desc: 'Tarçın süslemeli geleneksel sıcak salep. (185 kcal)', img: 'photos/çay.jpg', allergens: ['sut'] },
  { id: 88, category: 'sicak-icecek', name: 'Sıcak Çikolata', price: 175, desc: 'Yoğun kıvamlı çikolatalı sıcak içecek. (230 kcal)', img: 'photos/Aslı Çikolatalı Frappe 2.jpg', allergens: ['sut'] },
