...
const menuItems = [
  ...
  { id: 1, category: 'kahvalti', name: 'Serpme Kahvaltı (2 Kişilik)', price: 950, desc: 'Menemen veya sucuklu yumurta, ezine beyaz peyniri, taze kaşar, salam, siyah zeytin, yeşil zeytin, reçel, bal, tereyağı, domates, salatalık, yeşil biber, maydonoz, patates kızartması, peynirli su böreği ve sınırsız çay. (1750 kcal)', img: 'photos/serpme_kahvalti.webp', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 2, category: 'kahvalti', name: 'Çabuk Kahvaltı', price: 390, desc: 'Bal, yeşil biber, salatalık, domates, ezine peyniri, taze kaşar, reçel, simit, tereyağı, haşlanmış yumurta, siyah zeytin, yeşil zeytin, yanında 2 adet çay. (1439 kcal)', img: 'photos/cabuk_kahvalti.webp', allergens: ['gluten', 'sut', 'yumurta', 'susam'] },
  { id: 3, category: 'kahvalti', name: 'Sahanda Tereyağlı Yumurta', price: 125, desc: 'Sıcak sahanda taze tereyağlı yumurta. (245 kcal)', img: 'photos/sade_yumurta.webp', allergens: ['sut', 'yumurta'] },
  { id: 4, category: 'kahvalti', name: 'Sahanda Peynirli Yumurta', price: 140, desc: 'Lezzetli peynir harcı ile sahanda yumurta. (340 kcal)', img: 'photos/sahanda_peynirli_yumurta.webp', allergens: ['sut', 'yumurta'] },
  { id: 5, category: 'kahvalti', name: 'Sahanda Sucuklu Yumurta', price: 180, desc: 'Sucuk dilimleri ile pişirilmiş yumurta. (430 kcal)', img: 'photos/sahanda_sucuklu_yumurta.webp', allergens: ['yumurta'] },
  ...
  { id: 11, category: 'borek', name: 'Peynirli Su Böreği', price: 260, desc: 'Tereyağlı, peynirli su böreği. (223 kcal)', img: 'photos/peynirli_su_boregi.webp', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 12, category: 'borek', name: 'Kıymalı Kol Böreği', price: 290, desc: 'Dana kıymalı iç harcı ile çıtır kol böreği. (272 kcal)', img: 'photos/kolboregikiymali.webp', allergens: ['gluten', 'yumurta'] },
  { id: 13, category: 'borek', name: 'Patatesli Boşnak Böreği', price: 260, desc: 'Patates harçlı el açması Boşnak böreği. (255 kcal)', img: 'photos/bosnak_boregi_patatesli_porsiyon.webp', allergens: ['gluten', 'yumurta'] },
  { id: 14, category: 'borek', name: 'Kıymalı Boşnak Böreği', price: 320, desc: 'Dana kıymalı geleneksel Boşnak böreği. (220 kcal)', img: 'photos/bosnak_boregi_kiymali_porsiyon.webp', allergens: ['gluten', 'yumurta'] },
  { id: 15, category: 'borek', name: 'Sade Poğaça', price: 40, desc: 'Taze pişmiş yumuşacık sade poğaça. (360 kcal)', img: 'photos/pogacasade.webp', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 16, category: 'borek', name: 'Peynirli Poğaça', price: 40, desc: 'Peynir dolgulu nefis poğaça. (368 kcal)', img: 'photos/pogacapeynirli.webp', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 17, category: 'borek', name: 'Dereotlu Poğaça', price: 45, desc: 'Taze dereotlu poğaça. (446 kcal)', img: 'photos/pogacadereotlu.webp', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 18, category: 'borek', name: 'Simit', price: 40, desc: 'Susamlı simit. (302 kcal)', img: 'photos/sokak_simidi.webp', allergens: ['gluten', 'susam'] },
  { id: 19, category: 'borek', name: 'Beyaz Peynirli Tost', price: 180, desc: 'Ekşi mayalı tost ekmeğinde ezine peyniri, yanında mevsim yeşillikleri. (240 kcal)', img: 'photos/peynirli_tost.webp', allergens: ['gluten', 'sut'] },
  { id: 20, category: 'borek', name: 'Kaşarlı Tost', price: 180, desc: 'Ekşi mayalı tost ekmeğinde erimiş Mihaliç peyniri, yanında mevsim yeşillikleri. (275 kcal)', img: 'photos/kasarli_tost.webp', allergens: ['gluten', 'sut'] },
  { id: 21, category: 'borek', name: 'Karışık Tost', price: 210, desc: 'Ekşi mayalı tost ekmeğinde erimiş Mihaliç peyniri ile dilim dana sucuk, yanında mevsim yeşillikleri. (292 kcal)', img: 'photos/sucuklu_tost1.webp', allergens: ['gluten', 'sut'] },
  ...
  { id: 26, category: 'atistirmalik', name: 'Çıtır Tavuk Parçaları', price: 210, desc: 'Pane kaplamalı çıtır tavuk göğsü dilimleri, yanında baharatlı patates kızartması ile. (280 kcal)', img: 'photos/citirtavuk1.webp', allergens: ['gluten', 'yumurta'] },
  { id: 27, category: 'atistirmalik', name: 'Patates Kızartması', price: 150, desc: 'Baharatlı patates kızartması. (230 kcal)', img: 'photos/patates_kizartmasi.webp', allergens: [] },
  { id: 28, category: 'atistirmalik', name: 'Kaşar Peynirli Baget Sandviç', price: 150, desc: 'Baget ekmeğinde taze kaşar peyniri, salatalık, domates, krem peyniri ve yeşillik. (220 kcal)', img: 'photos/peynirli_baget.webp', allergens: ['gluten', 'sut'] },
  { id: 29, category: 'atistirmalik', name: 'Peynirli Baget Sandviç', price: 150, desc: 'Baget ekmeğinde taze beyaz peyniri, salatalık, domates, krem peyniri ve yeşillik. (170 kcal)', img: 'photos/peynirli_baget.webp', allergens: ['gluten', 'sut'] },
  { id: 30, category: 'atistirmalik', name: 'Kaşarlı Salamlı Baget Sandviç', price: 160, desc: 'Baget ekmeğinde dana salam, taze kaşar peyniri, salatalık, domates ve labne. (190 kcal)', img: 'photos/salamli_baget.webp', allergens: ['gluten', 'sut'] },
  ...
  { id: 34, category: 'atistirmalik', name: 'Ton Balıklı Salata', price: 330, desc: 'Ton balığı, haşlanmış yumurta, kırmızı soğan ve mısır ile. (330 kcal)', img: 'photos/tonbaliklisalata.webp', allergens: ['balik', 'yumurta'] },

  // --- ANA YEMEKLER, DÜRÜMLER, PİZZALAR VE MAKARNALAR ---
  { id: 35, category: 'ana-yemek', name: 'Izgara Köfte', price: 460, desc: 'Izgara köfte, pilav, patates kızartması, közlenmiş biber ve mevsim yeşillikleri ile servis edilir. (270 kcal)', img: 'photos/kofte_porsiyon.webp', allergens: ['gluten'] },
  { id: 36, category: 'ana-yemek', name: 'Köri Soslu Tavuk', price: 380, desc: 'Özel köri soslu sotelenmiş tavuk, pilav, patates kızartması ve mevsim yeşillikleri ile servis edilir. (165 kcal)', img: 'photos/korisoslutavuk.webp', allergens: ['sut'] },
  { id: 37, category: 'ana-yemek', name: 'Aslı Burger', price: 450, desc: '160g dana burger köftesi, dana füme, karamelize soğan, cheddar, domates, patates kızartması ve mevsim yeşillikleri ile servis edilir. (295 kcal)', img: 'photos/asli_burger.webp', allergens: ['gluten', 'sut', 'susam'] },
  ...
  { id: 40, category: 'ana-yemek', name: 'Tavuk Dürüm', price: 320, desc: 'Jülyen tavuk, kırmızı ve yeşil biber, lavaş ekmeği, cheddar, patates ve mevsim yeşillikleri ile servis edilir. (145 kcal)', img: 'photos/tavuk_durum.webp', allergens: ['gluten', 'sut'] },
  { id: 41, category: 'ana-yemek', name: 'Köfte Dürüm', price: 380, desc: 'Izgara köfte,kırmızı ve yeşil biber, lavaş ekmeği, cheddar, patates ve mevsim yeşillikleri ile servis edilir. (165 kcal)', img: 'photos/durum_kofte.webp', allergens: ['gluten', 'sut'] },
  ...
  { id: 49, category: 'ana-yemek', name: 'Mantı', price: 480, desc: 'Dana kıymalı ev mantısı, yoğurt ve tereyağlı sos ile. (225 kcal)', img: 'photos/manti_porsiyon.webp', allergens: ['gluten', 'sut', 'yumurta'] },

  // --- TATLILAR, PASTALAR & KURABİYELER ---
  { id: 50, category: 'tatli', name: 'Profiterol', price: 370, desc: 'Özel çikolata soslu profiterol topları. (315 kcal)', img: 'photos/profiterol_porsiyon.webp', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 51, category: 'tatli', name: 'Fırın Sütlaç', price: 320, desc: 'Geleneksel fırınlanmış sütlaç. (210 kcal)', img: 'photos/firinsutlac.webp', allergens: ['sut'] },
  ...
  { id: 54, category: 'tatli', name: 'Trileçe', price: 325, desc: 'Karamel soslu yumuşak trileçe. (245 kcal)', img: 'photos/trilece1.webp', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 55, category: 'tatli', name: 'Aslı Cup', price: 255, desc: 'Krema, çilekli Aslı Cup. (260 kcal)', img: 'photos/asli_cup.webp', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 56, category: 'tatli', name: 'Fıstıklı Baklava', price: 380, desc: 'Antep fıstıklı çıtır baklava. (422 kcal)', img: 'photos/baklavafistikli.webp', allergens: ['gluten', 'sut', 'kuruyemis'] },
  { id: 57, category: 'tatli', name: 'Cevizli Ev Baklavası', price: 330, desc: 'Bol cevizli ev baklavası. (401 kcal)', img: 'photos/cevizlievbaklavasi2.webp', allergens: ['gluten', 'sut', 'kuruyemis'] },
  { id: 58, category: 'tatli', name: 'Fıstıklı Kadayıf', price: 350, desc: 'Antep fıstıklı şerbetli kadayıf. (422 kcal)', img: 'photos/kadayifporsiyon.webp', allergens: ['gluten', 'sut', 'kuruyemis'] },
  { id: 59, category: 'tatli', name: 'Cevizli Sarı Burma', price: 320, desc: 'Cevizli sarı burma tatlısı. (401 kcal)', img: 'photos/sari_burma_porsiyon.webp', allergens: ['gluten', 'sut', 'kuruyemis'] },
  ...
  { id: 61, category: 'tatli', name: 'Böğürtlenli Cheesecake', price: 290, desc: 'Labne ve taze böğürtlen soslu cheesecake. (538 kcal)', img: 'photos/bogurtlenlicheesecake.webp', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 62, category: 'tatli', name: 'Fıstıklı Cheesecake', price: 290, desc: 'Antep fıstıklı cheesecake. (390 kcal)', img: 'photos/fistiklicheesecake.webp', allergens: ['gluten', 'sut', 'yumurta', 'kuruyemis'] },
  { id: 63, category: 'tatli', name: 'Fıstıklı Krokanlı Pasta', price: 315, desc: 'Fıstık ve çıtır krokan parçalı pasta. (322 kcal)', img: 'photos/fistiklikrokanli.webp', allergens: ['gluten', 'sut', 'yumurta', 'kuruyemis'] },
  ...
  { id: 65, category: 'tatli', name: 'Fıstıklı Çikolatalı Show Pasta', price: 335, desc: 'Çikolata ve Antep fıstıklı pasta. (421 kcal)', img: 'photos/cikolatalishow.webp', allergens: ['gluten', 'sut', 'yumurta'] },
  { id: 66, category: 'tatli', name: 'San Sebastian', price: 320, desc: 'Lezzetli İspanyol cheesecake. (420 kcal)', img: 'photos/san_sebastian_dilimlow.webp', allergens: ['sut', 'yumurta'] },
  ...
  // --- SICAK İÇECEKLER ---
  { id: 73, category: 'sicak-icecek', name: 'Aslı Çay', price: 50, desc: 'Geleneksel taze demlenmiş bardak Aslı çay.', img: 'photos/cay.webp', allergens: [] },
  ...
  { id: 75, category: 'sicak-icecek', name: 'Bitki Çayları', price: 150, desc: 'Ihlamur, adaçayı, yeşil çay seçenekleri.', img: 'photos/asli_bardak_kahve_1.webp', allergens: [] },
  { id: 76, category: 'sicak-icecek', name: 'Türk Kahvesi', price: 120, desc: 'Geleneksel köpüklü Türk kahvesi.', img: 'photos/turk_kahvesi.webp', allergens: [] },
  { id: 77, category: 'sicak-icecek', name: 'Duble Türk Kahvesi', price: 140, desc: 'Duble fincanda sunulan Türk kahvesi.', img: 'photos/turk_kahvesi.webp', allergens: [] },
  { id: 78, category: 'sicak-icecek', name: 'Caffe Latte', price: 160, desc: 'Espresso ve sıcak süt. (120 kcal)', img: 'photos/buzlu_latte.webp', allergens: ['sut'] },
  { id: 79, category: 'sicak-icecek', name: 'Caramel Latte', price: 190, desc: 'Karamel aromalı sıcak Caffe Latte. (180 kcal)', img: 'photos/asli_karamelli_frappe.webp', allergens: ['sut'] },
  { id: 80, category: 'sicak-icecek', name: 'Cappuccino', price: 160, desc: 'Yoğun espresso ve süt köpüğü. (90 kcal)', img: 'photos/asli_espresso_frappe.webp', allergens: ['sut'] },
  { id: 81, category: 'sicak-icecek', name: 'Caffe Mocha', price: 175, desc: 'Espresso, çikolata sosu ve süt. (210 kcal)', img: 'photos/buzlu_mocha.webp', allergens: ['sut'] },
  { id: 82, category: 'sicak-icecek', name: 'White Chocolate Mocha', price: 175, desc: 'Beyaz çikolata soslu Caffe Mocha. (240 kcal)', img: 'photos/buzlu_white_chocolate_mocha.webp', allergens: ['sut'] },
  ...
  { id: 86, category: 'sicak-icecek', name: 'Filtre Kahve', price: 130, desc: 'Taze demlenmiş filtre kahve. (2 kcal)', img: 'photos/filtre_kahve_paket_aslilow.webp', allergens: [] },
  { id: 87, category: 'sicak-icecek', name: 'Salep', price: 175, desc: 'Tarçın süslemeli geleneksel sıcak salep. (185 kcal)', img: 'photos/cay.webp', allergens: ['sut'] },
  { id: 88, category: 'sicak-icecek', name: 'Sıcak Çikolata', price: 175, desc: 'Yoğun kıvamlı çikolatalı sıcak içecek. (230 kcal)', img: 'photos/asli_cikolatali_frappe_2.webp', allergens: ['sut'] },
...
// DOM yükleme durumunu kontrol et (iOS Safari & QR kod okuyucu uyumluluğu için)
...
// iOS Safari BFCache (Önbellekten veya sekmeler arası geçişte geri yükleme) için
...
function checkOpenStatus() {
  ...
  if (hours >= 7 && hours < 23) {
    badge.textContent = "Şu An Açık (07:00 - 00:00)";
  ...
  categoryOrder.forEach(catKey => {
    ...
    if (catItems && catItems.length > 0) {
      ...
      catItems.forEach(item => {
        ...
        card.innerHTML = `
${!isBeverage ? `<img src="${item.img}" alt="${item.name}" loading="lazy" decoding="async">` : ''}          <div class="card-body">
            ${allergenHtml}
            <h3>${item.name}</h3>
            <p>${descText}</p>
